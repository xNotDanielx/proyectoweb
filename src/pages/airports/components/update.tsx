...
export const UpdateAirports = () => {
  ...
  const handleUpdateClick = async (updatedAirport: any, airport: any) => {
    ...
    const request = await apiRequest(airportToUpdate, `/FlyEaseApi/Aeropuertos/Put/${airport.idaereopuerto}`, "put");
    if(!request.error) {
      toast({
        description: "Se ha actualizado el aeropuerto exitosamente",
      });
    } else {
      toast({
        description: "No se ha podido actualizar el aeropuerto, intenta de nuevo.",
      });
    }
    mutate();
    };
  ...
  const handleRefreshClick = (airport: any) => {
    ...
    form.setValue(
      "associatedCity",
      `${airport.ciudad.idciudad},${airport.ciudad.nombre},${airport.ciudad.region.idregion},
       ${airport.ciudad.region.nombre}, ${airport.ciudad.region.pais.idpais},
                      ...
                      <SheetFooter>
                        <AlertDialog>
                          <AlertDialogTrigger asChild>
                            <Button variant="destructive">Actualizar aeropuerto</Button>
                          </AlertDialogTrigger>
                          <AlertDialogContent>
                            <AlertDialogHeader>
                              <AlertDialogTitle>¿Seguro que quieres actualizar el aeropuerto?</AlertDialogTitle>
                              <AlertDialogDescription>
                                Ten en cuenta que se actualizará el aeropuerto seleccionado!
                              </AlertDialogDescription>
                            </AlertDialogHeader>
                            <AlertDialogFooter>
                              <AlertDialogCancel>Cancelar</AlertDialogCancel>
                              <AlertDialogAction onClick={form.handleSubmit((updatedAirport) => handleUpdateClick(updatedAirport, item))}>
                                Actualizar
                              </AlertDialogAction>
                            </AlertDialogFooter>
                          </AlertDialogContent>
