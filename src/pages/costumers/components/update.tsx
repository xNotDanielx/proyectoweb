...
export const UpdateCostumers = () => {
  ...
  const handleUpdateClick = async (updatedCustomer: any, customer: Clientes) => {
    ...
    const request = await apiRequest(customerToUpdate, `/FlyEaseApi/Clientes/Put/${customer.numerodocumento}`, "put");
    if(!request.error) {
      toast({
        description: "Se ha actualizado el cliente exitosamente",
      });
    } else {
      toast({
        description: "No se ha podido actualizar el cliente, intenta de nuevo.",
      });
    }
    mutate();
  };
                    ...
                    >
                      ...
                      <AlertDialog>
                          <AlertDialogTrigger asChild>
                            <Button variant="destructive">Actualizar cliente</Button>
                          </AlertDialogTrigger>
                          <AlertDialogContent>
                            <AlertDialogHeader>
                              <AlertDialogTitle>¿Seguro que quieres actualizar el cliente?</AlertDialogTitle>
                              <AlertDialogDescription>
                                Ten en cuenta que se actualizará el cliente seleccionado!
                              </AlertDialogDescription>
                            </AlertDialogHeader>
                            <AlertDialogFooter>
                              <AlertDialogCancel>Cancelar</AlertDialogCancel>
                              <AlertDialogAction onClick={form.handleSubmit((updatedCustomer) => handleUpdateClick(updatedCustomer, customer))}>
                                Actualizar
                              </AlertDialogAction>
                            </AlertDialogFooter>
                          </AlertDialogContent>
