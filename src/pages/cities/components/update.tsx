...
export const UpdateCities = () => {
  ...
  const handleUpdateClick = async (updatedCity: any, city: any) => {
    ...
    const request = await apiRequest(cityToUpdate, `/FlyEaseApi/Ciudades/Put/${city.idciudad}`, "put");
    if(!request.error) {
      toast({
                      ...
                      <SheetFooter>
                        <AlertDialog>
                            <AlertDialogTrigger asChild>
                              <Button variant="destructive">Actualizar ciudad</Button>
                            </AlertDialogTrigger>
                            <AlertDialogContent>
                              <AlertDialogHeader>
                                <AlertDialogTitle>¿Seguro que quieres actualizar la ciudad?</AlertDialogTitle>
                                <AlertDialogDescription>
                                  Ten en cuenta que se actualizará la ciudad seleccionada!
                                </AlertDialogDescription>
                              </AlertDialogHeader>
                              <AlertDialogFooter>
                                <AlertDialogCancel>Cancelar</AlertDialogCancel>
                                <AlertDialogAction onClick={form.handleSubmit((updatedCity) => handleUpdateClick(updatedCity, item))}>
                                  Actualizar
                                </AlertDialogAction>
                              </AlertDialogFooter>
                            </AlertDialogContent>
