...
export const CreateCities = () => {
  ...
  const onSubmit = async (values: z.infer<typeof formSchema>) => {
    ...
    const request = await apiRequest(cityData, "/FlyEaseApi/Ciudades/Post", "post");

    if(!request.error){
      toast({
        description: "Se ha creado la ciudad exitosamente",      
      })
    }else{
      toast({
        description: "No se ha podido crear la ciudad, intente de nuevo.",
      })
    }    
