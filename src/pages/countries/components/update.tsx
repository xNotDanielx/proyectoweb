...
export const UpdateCountries = () => {
  ...
  const handleUpdateClick = async (updatedCountry: any, country: any) => {
    ...
    const request = await apiRequest(countryToUpdate, `/FlyEaseApi/Paises/Put/${country.idpais}`, "put");
    if(!request.error) {
      toast({
                    ...
                    >
                      ...
                      <AlertDialog>
                          <AlertDialogTrigger asChild>
                            <Button variant="destructive">Actualizar país</Button>
                          </AlertDialogTrigger>
                          <AlertDialogContent>
                            <AlertDialogHeader>
                              <AlertDialogTitle>¿Seguro que quieres actualizar el país?</AlertDialogTitle>
                              <AlertDialogDescription>
                                Ten en cuenta que se actualizará el país seleccionado!
                              </AlertDialogDescription>
                            </AlertDialogHeader>
                            <AlertDialogFooter>
