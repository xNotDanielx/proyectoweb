...
export const CreateAirlines = () => {
  ...
  const onSubmit = async (values: z.infer<typeof formSchema>) => {
    ...
    const request = await apiRequest(airlineData, "/FlyEaseApi/Aerolineas/Post", "post");
    
    if(!request.error){
      toast({
        description: "Se ha creado la aerolinea exitosamente",      
      })
    }else{
      toast({
        description: "No se ha podido crear la aerolinea, intente de nuevo.",
      })
    }    
  };
