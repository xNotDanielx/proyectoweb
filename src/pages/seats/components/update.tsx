...
export const UpdateSeats = () => {
  ...
  const handleUpdateClick = async (updatedSeat: any, seat: Asientos) => {
    ...
    const request = await apiRequest(plane, `/FlyEaseApi/Aviones/Put/${plane.idavion}`, "put");
    if (!request.error) {
      toast({
        description: "Se ha actualizado el asiento exitosamente",
      });
    } else {
      toast({
        description: "No se ha podido actualizar el asiento, intenta de nuevo.",
      });
    }
    mutate();
  };
                    ...
                    >
                      ...
                      <AlertDialog>
                          <AlertDialogTrigger asChild>
                            <Button variant="destructive">Actualizar asiento</Button>
                          </AlertDialogTrigger>
                          <AlertDialogContent>
                            <AlertDialogHeader>
                              <AlertDialogTitle>¿Seguro que quieres actualizar el asiento?</AlertDialogTitle>
                              <AlertDialogDescription>
                                Ten en cuenta que se actualizará el ultimo asiento seleccionado!
                              </AlertDialogDescription>
                            </AlertDialogHeader>
                            <AlertDialogFooter>
                              <AlertDialogCancel>Cancelar</AlertDialogCancel>
                              <AlertDialogAction onClick={form.handleSubmit((updatedSeat) => handleUpdateClick(updatedSeat, item))}>
                                Actualizar
                              </AlertDialogAction>
                            </AlertDialogFooter>
                          </AlertDialogContent>
