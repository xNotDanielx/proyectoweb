...
export const UpdatePlanes = () => {
  ...
  const handleUpdateClick = async (updatedPlane: any, plane: any) => {
    ...
    const request = await apiRequest(planeToUpdate, `/FlyEaseApi/Aviones/Put/${plane.idavion}`, "put");
    if (!request.error) {
      toast({
        description: "Se ha actualizado el avión exitosamente",
      });
    } else {
      toast({
        description: "No se ha podido actualizar el avión, intenta de nuevo.",
      });
    }
    mutate();
  };
                      ...
                      <SheetFooter>
                          <AlertDialog>
                            <AlertDialogTrigger asChild>
                              <Button variant="destructive">Actualizar avión</Button>
                            </AlertDialogTrigger>
                            <AlertDialogContent>
                              <AlertDialogHeader>
                                <AlertDialogTitle>¿Seguro que quieres actualizar el avión?</AlertDialogTitle>
                                <AlertDialogDescription>
                                  Ten en cuenta que se actualizará el avión seleccionado!
                                </AlertDialogDescription>
                              </AlertDialogHeader>
                              <AlertDialogFooter>
                                <AlertDialogCancel>Cancelar</AlertDialogCancel>
                                <AlertDialogAction onClick={form.handleSubmit((updatedPlane) => handleUpdateClick(updatedPlane, item))}>
                                  Actualizar
                                </AlertDialogAction>
                              </AlertDialogFooter>
                            </AlertDialogContent>
