...
export const CreateFlights = () => {
  ...
  const onSubmit = async (values: z.infer<typeof formSchema>) => {
    ...
    const request = await apiRequest(flightData, "/FlyEaseApi/Vuelos/Post", "post");


    if(!request.error){
      toast({
        description: "Se ha creado el vuelo exitosamente",      
      })
    }else{
      toast({
        description: "No se ha podido crear el vuelo, intente de nuevo.",
      })
    }    
  };
