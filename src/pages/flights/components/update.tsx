...
export const UpdateFlights = () => {
  ...
  const handleUpdateClick = async (updatedFlight: any, flight: any) => {  
    ...
    const request = await apiRequest(flightData, `/FlyEaseApi/Vuelos/Put/${flight.idvuelo}`, "put");
    if (!request.error) {
      toast({
        description: "Se ha actualizado el vuelo exitosamente",
      });
    } else {
      toast({
        description: "No se ha podido actualizar el vuelo, intenta de nuevo.",
      });
    }
    mutate();
  };
                      ...
                      <SheetFooter>
                          <AlertDialog>
                            <AlertDialogTrigger asChild>
                              <Button variant="destructive">Actualizar vuelo</Button>
                            </AlertDialogTrigger>
                            <AlertDialogContent>
                              <AlertDialogHeader>
                                <AlertDialogTitle>¿Seguro que quieres actualizar el vuelo?</AlertDialogTitle>
                                <AlertDialogDescription>
                                  Ten en cuenta que se actualizará el asiento seleccionado!
                                </AlertDialogDescription>
                              </AlertDialogHeader>
                              <AlertDialogFooter>
                                <AlertDialogCancel>Cancelar</AlertDialogCancel>
                                <AlertDialogAction onSubmit={form.handleSubmit((updatedFlight) => handleUpdateClick(updatedFlight, item))}>
                                  Actualizar
                                </AlertDialogAction>
                              </AlertDialogFooter>
                            </AlertDialogContent>
